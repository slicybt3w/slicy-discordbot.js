...
export class oldSlicyDB {
     ...
     * @example <slicyDB>.set("test","js is cool")
     */
     ...
     * @example <slicyDB>.get("test") //Will return "js is cool" (if you have set it)
     */
     ...
     * @example <slicyDB>.has("test") // will return true if there is a key
     */
     ...
     * @example <slicyDB>.delete("test")
     */
    delete(key: string): Promise<void>;
}

export class slicyDB {
    /**
     * @name slicyDB
     * @kind constructor
